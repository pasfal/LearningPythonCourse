...
#Matrice 1 - Tentativi di tiri liberi per partita
FreeThrowAttemptsForGame = FreeThrowAttempts / Games
plotData(FreeThrowAttemptsForGame, yLabel="Free Throw Attempts For Games")

#Matrice 2 - Precisione dei tiri liberi
FreeThrowsPrecision = FreeThrows / FreeThrowAttempts
#FreeThrowsPrecision = FreeThrowAttempts / FreeThrows
plotData(FreeThrowsPrecision, "Free Throws Precision")

#Matrice 3 - Preferenza di canestri da 2 punti e canestri da 3 punti (escludendo i tiri liberi)
PlayerGameStyle = (Points - FreeThrows) / FieldGoals
plotData(PlayerGameStyle, "Game style for player")
